-- Fase 22 · Traslado Acuático, según el documento del 2026-09-23.
--
...
alter table public.att_acuaticos
...
comment on column public.att_acuaticos.monto is
  'Derivado: tarifa de servicio + monto de extras. Se recalcula al guardar.';
comment on column public.att_acuaticos.confirmacion_path is
...
-- falla la vieja.
alter table public.att_acuaticos drop constraint if exists att_acuaticos_estado_pago_check;
alter table public.att_acuaticos drop constraint if exists att_acuaticos_estado_pago_chk;
alter table public.att_acuaticos add constraint att_acuaticos_estado_pago_chk
